...
Controller.someOtherMethod = function () {};
...
Controller.extend = function (props) {
  ...
  var controller = function () {
    ...
    if (_.has(props, 'constructor'))
      ...
      ctor = controller.__super__.constructor;
  ...
  Middle.prototype = self.prototype;
  controller.prototype = new Middle;
  controller.__super__ = self.prototype;

  // copy over the props
  _.extend(controller.prototype, props);
